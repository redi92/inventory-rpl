          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="jenis_barang">
                ...
                <option value="sarana" @if($barang->jenis_barang == "sarana") selected @endif>Sarana</option>
                <option value="prasarana" @if($barang->jenis_barang == "prasarana") selected @endif>Prasarana</option>
              </select>
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Status Barang</label>
              <input type="text" name="status_barang" value="{{ $barang->nama_status}}" class="form-control" id="exampleInputPassword1" placeholder="Masukan Status Barang rusak ringan">
              <select class="form-control" name="status_barang">
                @foreach ($sts_barang as $status)
                  <option value={{ "$status->nama_status" }}
                    @if ($status->nama_status == "Bagus")
                        selected
                    @else
                      selected
                    @endif
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="exampleInputPassword1">Status Barang</label>
                    <select class="form-control" name="status_barang">
                      @foreach ($sts_barang as $sts_barang)
                      <option value={{ "$sts_barang->id_status" }}>{{ "$sts_barang->nama_status" }}</option>
                      @endforeach
                      </select>
                  </div>
                  <div class="form-group">
